...
def check_mouse_events(settings, event, screen, centre, red, blue, move, bhar,
	...
	for i in range (1,25):
		if (mouse_x <= centre[i][0]+r and mouse_x >= centre[i][0]-r and
				...
				if move[0] and red[i] == False and blue[i] == False:
					if movable(move, i):
						...
						if n == 2 or n == 1 and count[0]%2 == 1:
							move[0] = 0
							count[0] += 1
def check_events(settings, screen, centre, red, blue, move, bhar, count):
...
def movable(move, i):
	...
	if (move[0] == 1 and (i == 2 or i == 10) or
		...
		move[0] == 5 and (i == 2 or i == 4 or i == 6 or 
		i == 8) or
		...
		move[0] == 11 and (i == 4 or i == 10 or i == 12 or 
		i == 19) or
		move[0] == 12 and (i == 7 or i == 11 or i == 16) or
		move[0] == 13 and (i == 9 or i == 14 or i == 18) or
		move[0] == 14 and (i == 6 or i == 13 or i == 15 or 
		i == 21) or
		...
		move[0] == 20 and (i == 17 or i == 19 or i == 21 or 
		i == 23) or
...
def is_bhar(i, red, blue, turn):
	...
	if (turn == 1) and (
		i == 1 and red[2] and red[3] or
		i == 1 and red[10] and red[22] or
		i == 2 and red[1] and red[3] or
		i == 2 and red[5] and red[8] or
		i == 3 and red[1] and red[2] or
		i == 3 and red[15] and red[24] or
		i == 4 and red[5] and red[6] or
		i == 4 and red[11] and red[19] or
		i == 5 and red[4] and red[6] or
		i == 5 and red[2] and red[8] or
		i == 6 and red[4] and red[5] or
		i == 6 and red[14] and red[21] or
		i == 7 and red[8] and red[9] or
		i == 7 and red[12] and red[16] or
		i == 8 and red[2] and red[5] or
		i == 8 and red[7] and red[9] or
		i == 9 and red[7] and red[8] or
		i == 9 and red[13] and red[18] or
		i == 10 and red[1] and red[22] or
		i == 10 and red[11] and red[12] or
		i == 11 and red[4] and red[19] or
		i == 11 and red[10] and red[12] or
		i == 12 and red[7] and red[16] or
		i == 12 and red[10] and red[11] or
		i == 13 and red[9] and red[18] or
		i == 13 and red[14] and red[15] or
		i == 14 and red[6] and red[21] or
		i == 14 and red[13] and red[15] or
		i == 15 and red[3] and red[24] or
		i == 15 and red[13] and red[14] or
		i == 16 and red[7] and red[12] or
		i == 16 and red[17] and red[18] or
		i == 17 and red[16] and red[18] or
		i == 17 and red[20] and red[23] or
		i == 18 and red[9] and red[13] or
		i == 18 and red[16] and red[17] or
		i == 19 and red[4] and red[11] or
		i == 19 and red[20] and red[21] or
		i == 20 and red[17] and red[23] or
		i == 20 and red[19] and red[21] or
		i == 21 and red[6] and red[14] or
		i == 21 and red[19] and red[20] or
		i == 22 and red[1] and red[10] or
		i == 22 and red[23] and red[24] or
		i == 23 and red[17] and red[20] or
		i == 23 and red[22] and red[24] or
		i == 24 and red[3] and red[15] or
		i == 24 and red[22] and red[23]
		):
		return True
	if (turn == 2) and (
		i == 1 and blue[2] and blue[3] or
		i == 1 and blue[10] and blue[22] or
		i == 2 and blue[1] and blue[3] or
		i == 2 and blue[5] and blue[8] or
		i == 3 and blue[1] and blue[2] or
		i == 3 and blue[15] and blue[24] or
		i == 4 and blue[5] and blue[6] or
		i == 4 and blue[11] and blue[19] or
		i == 5 and blue[4] and blue[6] or
		i == 5 and blue[2] and blue[8] or
		i == 6 and blue[4] and blue[5] or
		i == 6 and blue[14] and blue[21] or
		i == 7 and blue[8] and blue[9] or
		i == 7 and blue[12] and blue[16] or
		i == 8 and blue[2] and blue[5] or
		i == 8 and blue[7] and blue[9] or
		i == 9 and blue[7] and blue[8] or
		i == 9 and blue[13] and blue[18] or
		i == 10 and blue[1] and blue[22] or
		i == 10 and blue[11] and blue[12] or
		i == 11 and blue[4] and blue[19] or
		i == 11 and blue[10] and blue[12] or
		i == 12 and blue[7] and blue[16] or
		i == 12 and blue[10] and blue[11] or
		i == 13 and blue[9] and blue[18] or
		i == 13 and blue[14] and blue[15] or
		i == 14 and blue[6] and blue[21] or
		i == 14 and blue[13] and blue[15] or
		i == 15 and blue[3] and blue[24] or
		i == 15 and blue[13] and blue[14] or
		i == 16 and blue[7] and blue[12] or
		i == 16 and blue[17] and blue[18] or
		i == 17 and blue[16] and blue[18] or
		i == 17 and blue[20] and blue[23] or
		i == 18 and blue[9] and blue[13] or
		i == 18 and blue[16] and blue[17] or
		i == 19 and blue[4] and blue[11] or
		i == 19 and blue[20] and blue[21] or
		i == 20 and blue[17] and blue[23] or
		i == 20 and blue[19] and blue[21] or
		i == 21 and blue[6] and blue[14] or
		i == 21 and blue[19] and blue[20] or
		i == 22 and blue[1] and blue[10] or
		i == 22 and blue[23] and blue[24] or
		i == 23 and blue[17] and blue[20] or
		i == 23 and blue[22] and blue[24] or
		i == 24 and blue[3] and blue[15] or
		i == 24 and blue[22] and blue[23]
		):
		return True
	return False
def draw_board(settings, screen, centre, red, blue, move, bhar, count):
